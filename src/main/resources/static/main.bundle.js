...
var AdminPanelService = (function () {
    ...
    AdminPanelService.prototype.handleError = function (operation, result) {
        var _this = this;
    ...
    AdminPanelService.prototype.log = function (message) {
        console.log(message);
    };
...
var routes = [
    {
        ...
        children: [
            ...
            { path: 'doctorsdetails', component: __WEBPACK_IMPORTED_MODULE_15__doctors_doctor_details_doctor_details_component__["a" /* DoctorDetailsComponent */] },
        ]
    },
    { path: 'specs/:id', component: __WEBPACK_IMPORTED_MODULE_6__specdetails_specdetails_component__["a" /* SpecdetailsComponent */], },
...
var DoctorDetailsComponent = (function () {
    function DoctorDetailsComponent(doctorDetailsService) {
        this.doctorDetailsService = doctorDetailsService;
    }
    DoctorDetailsComponent.prototype.ngOnInit = function () {
        this.getDoctors();
    };
    DoctorDetailsComponent.prototype.getDoctors = function () {
        var _this = this;
        this.doctorDetailsService.getDoctors().subscribe(function (doctors) {
            _this.doctors = doctors;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__doctors_service__ = __webpack_require__("../../../../../src/app/doctors/doctors.service.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var DoctorDetailsService = (function () {
    function DoctorDetailsService(http, doctorsService) {
        this.http = http;
        this.API_URL = '//localhost:9080/doctors';
    }
    DoctorDetailsService.prototype.getDoctors = function () {
        var _this = this;
    ...
    DoctorDetailsService = __decorate([
        ...
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__angular_common_http__["a" /* HttpClient */],
            __WEBPACK_IMPORTED_MODULE_7__doctors_service__["a" /* DoctorsService */]])
